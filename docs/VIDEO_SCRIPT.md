...
**Show:** The single Live AI Assessment option, scenario context, card selection, progress through the eight decisions, Continue, then Submit strategy. Keep the saving and GPT-5.6 generation overlays visible briefly.
...
**Show:** Make one selection in each of the four card groups, then Submit for evaluation and its processing state. If available, briefly show the evaluation retry processing state.
...
- Complete the Preview verification first, then promote that exact verified artifact before recording Production.
